...
ANPC_LIFECharacter::ANPC_LIFECharacter()
{
...
void ANPC_LIFECharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void ANPC_LIFECharacter::SetupStimulusSource()
{
...
void ANPC_LIFECharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ANPC_LIFECharacter::Move);
...
void ANPC_LIFECharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ANPC_LIFECharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
